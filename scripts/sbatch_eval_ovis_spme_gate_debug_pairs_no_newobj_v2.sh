...
#SBATCH --mem=64G
#SBATCH -t 12:00:00
#SBATCH -J sam3_spme_gate_debug_no_newobj_v2
...
OUT_ROOT=${OUT_ROOT:-/home2020/home/icube/kunyuan/SurgBench/SAM/outputs/spme_gate_ovis_debug_pairs_no_newobj_v2/job_${SLURM_JOB_ID:-local}}
